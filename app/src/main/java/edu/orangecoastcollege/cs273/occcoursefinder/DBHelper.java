...
class DBHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase database) {
        String createQuery = "CREATE TABLE " + COURSES_TABLE + "("
                ...
                + FIELD_NUMBER + " TEXT, "
                + FIELD_TITLE + " TEXT" + ")";
        // String ends up being CREATE TABLE Courses(id INTEGER PRIMARY KEY AUTOINCREMENT,
        // alpha TEXT, number TEXT, title TEXT); <-- semicolon automatically inserts semicolon
